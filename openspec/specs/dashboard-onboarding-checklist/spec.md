# dashboard-onboarding-checklist Specification

## Purpose
Provide onboarding guidance for new users by showing empty states and a setup checklist to drive activation.
