...
This CLAUDE.md file should be kept up-to-date as the codebase evolves. Use the following methods to maintain it:

#### Method 1: Using Claude Code CLI (Recommended)

When significant architecture changes occur, use the `/init` command:
...
- Identify changes since last documentation update
- Suggest improvements or additions to CLAUDE.md
- Update architecture diagrams and command references

#### Method 2: Manual Updates

Update CLAUDE.md when you make these types of changes:

**Always Update For**:
- New environment variables added
- Database schema major changes (new models, important relationships)
...
- New common development scenarios
- New troubleshooting scenarios discovered
- Changes to Notion sync behavior
- Updates to Prisma version or patterns

#### Method 3: Automated GitHub Actions (Optional)
        ...
        with:
          script: |
            github.rest.issues.createComment({
              ...
              body: '⚠️ Core files changed. Consider updating CLAUDE.md with `/init` command.'
            })
```

### Documentation Review Checklist

Before committing major changes, verify CLAUDE.md includes:

- [ ] All new environment variables documented
- [ ] Updated command list if scripts changed
- [ ] Architecture changes reflected in "Architecture Overview"
- [ ] New troubleshooting entries for common issues encountered
- [ ] Deployment notes updated if process changed
- [ ] Prisma/database changes reflected in data model section

### Version History

Track major documentation updates here:

- **2026-01-15**: Initial CLAUDE.md creation with comprehensive architecture guide
- *(Add entries as significant updates occur)*
