...
export function IntegrationGuidanceCard({ type, href }: IntegrationGuidanceCardProps) {
  ...
  return (
    <Link
      href={href}
      className="group block p-8 bg-slate-50 border-2 border-dashed border-slate-200 rounded-lg hover:bg-white hover:border-brand-primary/40 hover:shadow-md transition-shadow text-center space-y-4"
    >
