            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-start gap-20">
                    <div className="max-w-sm">
                        ...
                        <div className="flex gap-5">
                            ...
                            <a href="https://github.com/jack-scaletotop" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-brand-border flex items-center justify-center text-brand-text-muted hover:text-brand-primary hover:border-brand-primary transition-all">
                ...
                <div className="mt-24 pt-10 border-t border-brand-border flex flex-col sm:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8 text-[10px] font-bold uppercase tracking-[0.2em] text-brand-text-muted">
                        <a href="https://status.scaletotop.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand-primary">系统状态</a>
