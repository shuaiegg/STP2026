...
export function creditsWarningEmailHtml(name: string, remaining: number, locale = 'zh'): string {
  if (locale === 'en') {
        ...
        <tr>
          <td style="padding:32px 40px;">
            <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:16px;margin-bottom:24px;display:flex;align-items:center;">
              ...
              <span style="font-size:14px;color:#9a3412;font-weight:500;">Low Credits Alert</span>
            </div>
            <h1 style="margin:0 0 16px;font-size:22px;font-weight:700;color:#111827;">Hi ${displayName}, your credits are running low</h1>
            <p style="margin:0 0 24px;font-size:16px;color:#6b7280;line-height:1.6;">
              You currently have <strong style="color:#ef4444;font-size:20px;">${remaining}</strong> credits remaining. We suggest recharging soon to ensure your AI tools remain active.
            </p>
        ...
        <tr>
          <td style="padding:20px 40px;border-top:1px solid #f3f4f6;">
            <p style="margin:0;font-size:12px;color:#9ca3af;">
              Credits drive site audits, content generation, and other AI features. This warning is sent at most once every 24 hours.
            </p>
          </td>
        </tr>
      </table>
