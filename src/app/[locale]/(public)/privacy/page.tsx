...
import { EnglishVersionToggle } from './EnglishVersionToggle';
        ...
        return (
            <div className="bg-brand-surface min-h-screen py-20 px-6">
                <div className="max-w-3xl mx-auto">
                    <h1 className="font-display text-4xl md:text-5xl font-black text-brand-text-primary mb-4 italic">Privacy Policy</h1>
                    <p className="text-brand-text-secondary font-mono text-sm uppercase tracking-widest mb-12">Last updated: {lastUpdated}</p>
                    <div className="whitespace-pre-wrap text-sm leading-relaxed text-brand-text-secondary bg-white border-2 border-brand-border rounded-2xl p-8">{renderContent(englishContent)}</div>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="bg-brand-surface min-h-screen py-20 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                <EnglishVersionToggle content={englishContent} />
