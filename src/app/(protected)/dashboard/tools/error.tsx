  ...
  return (
    <div role="alert" className="flex flex-col items-center justify-center min-h-[400px] p-6 text-center space-y-6">
      ...
      <div className="space-y-2">
        <h2 className="text-xl font-bold font-display text-brand-text-primary">{t('tools.title')}</h2>
        <p className="text-sm text-brand-text-secondary max-w-xs mx-auto">{t('tools.description')}</p>
      </div>
      <Button
        onClick={() => reset()}
