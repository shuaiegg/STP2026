    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-xl hover:bg-slate-100 transition-colors group"
            >
            ...
            {isOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-100 origin-top-left">
                    <div className="p-2 border-b border-slate-100 bg-slate-50/50">
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest px-2">切换站点</p>
                    </div>
                    <div className="max-h-64 overflow-y-auto p-1">
                        {sites.map((site) => (
                            <button
                                ...
                                className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-left transition-colors ${site.id === currentSiteId
                    ...
                    <div className="p-2 border-t border-slate-100 bg-slate-50/30">
                        <Link href="/dashboard/site-intelligence/instant-audit">
                            <button
                                ...
                                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-slate-600 hover:bg-white hover:text-brand-primary hover:shadow-sm border border-transparent hover:border-slate-100 transition-all text-xs font-bold"
                            >
