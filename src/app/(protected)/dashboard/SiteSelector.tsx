  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-black text-brand-text-primary tracking-tight">{t('title')}</h1>
        <p className="text-brand-text-muted font-medium">{t('subtitle')}</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {sites.map(site => (
          <Link
            ...
            className="group bg-white border border-brand-border-heavy rounded-lg p-6 hover:shadow-md transition-shadow flex flex-col justify-between"
          >
            <div>
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-lg bg-brand-surface flex items-center justify-center text-brand-text-muted group-hover:text-brand-primary group-hover:bg-brand-primary/5 transition-colors">
              ...
              <h2 className="text-xl font-bold text-brand-text-primary truncate mb-1">{site.domain}</h2>
              ...
              <div className="flex items-center gap-2 text-brand-text-muted text-sm mb-6">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-brand-surface">
              ...
              <div className="w-8 h-8 rounded-lg bg-brand-surface flex items-center justify-center group-hover:bg-brand-primary group-hover:text-white transition-all">
        ...
        <Link
          ...
          className="bg-brand-surface border-2 border-dashed border-brand-border-heavy rounded-lg p-6 hover:bg-white hover:border-brand-primary/40 hover:shadow-md transition-shadow flex flex-col items-center justify-center text-center gap-4 group"
        >
          <div className="w-12 h-12 rounded-lg bg-white border border-brand-border-heavy flex items-center justify-center text-brand-text-muted group-hover:text-brand-primary group-hover:border-brand-primary/20 transition-all">
            <Plus size={24} aria-hidden="true" />
          </div>
          <div>
            <h3 className="font-bold text-brand-text-primary">{t('addSite')}</h3>
            <p className="text-xs text-brand-text-muted">{t('addSiteDesc')}</p>
          </div>
        </Link>
      </div>
    </div>
