      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <NavLink to="/" end className={({isActive}) => `flex items-center group text-sm font-semibold transition-all py-2 ${isActive ? 'text-brand-primary' : 'text-brand-text-secondary hover:text-brand-primary'}`}>
              <NavIcon type="home" />
              首页
            </NavLink>
            <NavLink to="/blog" className={({isActive}) => `flex items-center group text-sm font-semibold transition-all py-2 ${isActive ? 'text-brand-primary' : 'text-brand-text-secondary hover:text-brand-primary'}`}>
              <NavIcon type="blog" />
              博客文章
            </NavLink>
            <NavLink to="/course" className={({isActive}) => `flex items-center group text-sm font-semibold transition-all py-2 ${isActive ? 'text-brand-primary' : 'text-brand-text-secondary hover:text-brand-primary'}`}>
              <NavIcon type="course" />
              实战课程
            </NavLink>
            <NavLink to="/tools" className={({isActive}) => `flex items-center group text-sm font-semibold transition-all py-2 ${isActive ? 'text-brand-primary' : 'text-brand-text-secondary hover:text-brand-primary'}`}>
              <NavIcon type="tools" />
              效率工具
            </NavLink>
          </nav>
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-20">
            <div>
              ...
              <ul className="space-y-4 text-sm text-brand-text-secondary">
                <li><Link to="/course" className="hover:text-brand-primary transition-colors">技术型 SEO 课程</Link></li>
                <li><Link to="/tools" className="hover:text-brand-primary transition-colors">pSEO 自动化工具</Link></li>
                <li><Link to="#" className="hover:text-brand-primary transition-colors">增长咨询服务</Link></li>
              </ul>
            </div>
            <div>
              <h5 className="text-brand-text-primary font-bold text-sm mb-8 tracking-widest uppercase">知识库</h5>
              <ul className="space-y-4 text-sm text-brand-text-secondary">
                <li><Link to="/blog" className="hover:text-brand-primary transition-colors">最新文章</Link></li>
                <li><Link to="#" className="hover:text-brand-primary transition-colors">案例拆解</Link></li>
                <li><Link to="#" className="hover:text-brand-primary transition-colors">技术文档</Link></li>
              </ul>
            </div>
            <div>
              <h5 className="text-brand-text-primary font-bold text-sm mb-8 tracking-widest uppercase">关于</h5>
              <ul className="space-y-4 text-sm text-brand-text-secondary">
                <li><Link to="#" className="hover:text-brand-primary transition-colors">隐私声明</Link></li>
                <li><Link to="#" className="hover:text-brand-primary transition-colors">服务条款</Link></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="mt-24 pt-10 border-t border-brand-border flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-[10px] font-bold uppercase tracking-[0.2em] text-brand-text-muted">
             <Link to="#" className="hover:text-brand-primary">Status</Link>
             <Link to="#" className="hover:text-brand-primary">Contact</Link>
             <Link to="#" className="hover:text-brand-primary">English</Link>
          </div>
        </div>
      </div>
    </footer>
